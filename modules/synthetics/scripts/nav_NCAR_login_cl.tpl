...
// Seleziona ufficio
const officeChoice = await waitForAndFindElement($selenium.By.xpath('//*[@id="bean"]/tbody/tr[1]/td[1]/input'))
await officeChoice.click().then(function(){
	console.log('Ufficio selezionato');
});

// Submit
const officeSubmitButton = await waitForAndFindElement($selenium.By.xpath('/html/body/table/tbody/tr/td/form[1]/table[2]/tbody/tr/td[3]/input'))
await officeSubmitButton.click().then(function(){
	console.log('Submit eseguito');
});
